                ...
                leading: ClipRRect(
                  ...
                  child: Image.network(
                    ...
                    errorBuilder: (_, __, ___) =>
                        const Icon(Icons.fastfood, color: kMuted),
                  ),
                ),
                title: Text(
                  data['name'] ?? '',
                ...
                trailing: Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (_) =>
                                EditMenuItemPage(docId: docId, itemData: data),
                          ),
                        );
                      },
                    ),
                    IconButton(
                      ...
                      onPressed: () =>
                          _deleteItem(context, docId, data['name'] ?? 'Item'),
                    ),
                  ],
                ),
              ),
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: [_buildListForType('food'), _buildListForType('drink')],
        ),
      ),
    );
  }
