// lib/edit_delete_drinks_menu.dart
...
class EditDeleteDrinksMenuPage extends StatefulWidget {
  const EditDeleteDrinksMenuPage({super.key});
  @override
  State<EditDeleteDrinksMenuPage> createState() =>
      _EditDeleteDrinksMenuPageState();
}

class _EditDeleteDrinksMenuPageState extends State<EditDeleteDrinksMenuPage> {
  ...
  Future<void> _deleteDrink(DocumentSnapshot doc) async {
                ...
                if ((imageFileName ?? '').isNotEmpty) {
                  try {
                    await FirebaseStorage.instance
                        .ref('drinks_images/$imageFileName')
                        .delete();
                  } catch (_) {}
                }
              }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: kBg,
        foregroundColor: kWhite,
        title: const Text('Edit / Delete Drinks Menu'),
      ),
