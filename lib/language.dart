...
class AppLanguage {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'de': {
      ...
      'otp_sent_to': 'Wir haben einen Code gesendet an',
      'get_started': 'Loslegen',
      'login_to_order': 'Bitte melden Sie sich an, um zu bestellen.',
      'login_to_continue': 'Bitte melden Sie sich an, um fortzufahren.',
      ...
      'Phone': 'Telefon',
      'E-Mail': 'E-Mail',
      'Note (optional)': 'Bemerkung (optional)',
      'Confirm booking': 'Reservierung bestätigen',
      'Table booked': 'Tisch reserviert',
      'Please choose a table.': 'Bitte wählen Sie einen Tisch.',
      'Please choose a time.': 'Bitte wählen Sie eine Uhrzeit.',
      'Name and phone are required.':
          'Name und Telefon sind erforderlich.',
      ...
      'Price': 'Preis',
      'from': 'ab',
      'Hall rental prices': 'Saalmiete',
      'Please choose a duration.': 'Bitte wählen Sie die Dauer.',
      'Please check your booking': 'Bitte prüfen Sie Ihre Reservierung',
      'Hall booked': 'Saal reserviert',
      'Confirm': 'Bestätigen',
      'Back': 'Zurück',
      'Pick a start time first.': 'Bitte zuerst eine Startzeit wählen.',
      'No tables are available for booking yet.':
          'Es sind noch keine Tische zur Reservierung verfügbar.',
    ...
    'en': {
      ...
      'login_to_order': 'Please sign in to place an order.',
      ...
      'Name and phone are required.': 'Name and phone are required.',
      'Sorry, that table was just booked. Please pick another time.':
          'Sorry, that table was just booked. Please pick another time.',
      ...
      'Price': 'Price',
      'from': 'from',
      'Hall rental prices': 'Hall rental prices',
      'Please choose a duration.': 'Please choose a duration.',
      'Please check your booking': 'Please check your booking',
      'Hall booked': 'Hall booked',
      'Confirm': 'Confirm',
      'Back': 'Back',
      'Pick a start time first.': 'Pick a start time first.',
      'No tables are available for booking yet.':
          'No tables are available for booking yet.',
      'My Orders': 'My Orders',
      'Service': 'Service',
